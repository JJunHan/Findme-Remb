...
<div id="menubar">
<ul id="menu">
	<li class="selected"><a href="findme.html">Find Me</a> </li>
	<li><a href="remb.html">Remb</a></li>
...
$dbconnection = @mysqli_connect("localhost","root","");
            ...
            if (!mysqli_select_db($dbconnection, "database"))
            {
			 ...
			 setcookie("users_ID1", "$users_ID");
			 
			 
            $result = @mysqli_query($dbconnection,'SELECT Score FROM z1');
            if (!$result)
            {
            ...
            $result = mysqli_query($dbconnection,"SELECT * FROM z1 WHERE ID='$users_ID'"); //check z1 because i force data into z1 empty scores but with all new usernames
...
<div id="styling4">
<form action="findmereview.php" id="form111" method="POST" name="form">
...
<div id="movingaudiodiv">
	<object id="movingaudio" type="text/html" data="findme/fmreview.php"  height="800px" style="border:1px ridge #585858; width:60%;background: white;overflow:hidden; right:23px; position:relative;">
...
<div id="footer">
<p><a href="home1.html">Home</a> | <a href="aboutus.php">About Us</a> | <a href="aboutus.php">Contact Us</a> <br>
<center>Project 1B16215 </center>
</div>

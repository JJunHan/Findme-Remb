...
<div id="styleform1">
<form action="level4db.php" id="form11" method="POST">
...
<div id="styleform2">	
<form action="update4.php" id="form2" method="POST" name="form2">
...
<div id="movepictures">
 <img src="highscore.png" width="20px" height="30px" id="pic1"> 
	...
	<audio hidden style="position:absolute" id="myVid" autoplay="autoplay" controls="controls" loop="loop" src="2000_2s.mp3"></audio>
...
function doStuff() {
   ...
   if (event.clientX < posX + 100
		...
		backgroundAudio.volume=0.01; // or do other stuff here
		...
		backgroundAudio.volume=0.004; // or do other stuff here
		backgroundAudio.playbackRate = 2;
		...
		backgroundAudio.volume=0.002; // or do other stuff here
		backgroundAudio.playbackRate = 2;
		...
		backgroundAudio.volume=0.001; // or do other stuff here
		backgroundAudio.playbackRate = 2;

...
text-align: center;
 ...
 <body bgcolor="#E6E6FA">
  ...
  <a href="selectmode.php" style="position:absolute; z-index:2;"><u>Back</u></a>
    ...
    <font color="black"><strong><p id="text1">Frequency</p></font></strong>
	<div id="movepics">
	...
	<div id="move1">
	<a href="clevel1pre.php"><img src="level1.png" width="158px" height="69px" id="image1"></a>
	</div>
	...
	<div id="move2">
	<a href="clevel2pre.php"><img src="level2.png" width="158px" height="68px" id="image2"></a>
	</div>
	...
	<div id="move3">
	<a href="clevel3pre.php"><img src="level3.png" width="158px" height="68px" id="image3"></a>
	</div>
	...
	<div id="move4">
	<a href="clevel4pre.php"><img src="level4.png" width="158px" height="68px" id="image4"></a>
	</div>
	...
	<div id="move5">
	<a href="clevel5pre.php"><img src="level5.png" width="158px" height="68px" id="image5"></a>
	</div>
	...
	<div id="move6">
	<a href="clevel6pre.php"><img src="level6.png" width="158px" height="68px" id="image6"></a>
	</div>
	...
	<div id="move8">
	<img src="roundedsquare.png" width="383px" height="530px" id="square">
	</div>
	 ...
	 function chooselevel()
 {
   ...
   if(multiple == 1)
   {
	  window.location.href = "clevel1pre.php";
   }
    if(multiple == 2)
   {
	   window.location.href = "clevel2pre.php";
   }
    if(multiple == 3)
   {
	  window.location.href = "clevel3pre.php";
   }
    if(multiple == 4)
   {
	  window.location.href = "clevel4pre.php";
   }
    if(multiple == 5)
   {
	  window.location.href = "clevel5pre.php";
   }
    if(multiple == 6)
   {
	  window.location.href = "clevel6pre.php";
   }

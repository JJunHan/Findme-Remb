...
<body bgcolor="#e6e6fa">
<div id="move1">
	<a href="clevel1.php"><img src="level1.png" width="158px" height="69px" id="image1"></a>
	</div>
<a href="freq_level.php"><img src="back.png" id="back1"></a>
<div id="movedatabase">
<form action="cdelete1.php" method="POST">
            <?PHP
            ...
            $result = @mysqli_query($dbconnection,'SELECT ID FROM clevel1db');
            if (!$result)
            {
            ...
            $x="<SCRIPT type =text/javascript> document.write(a)</SCRIPT> ";
              ...
              $result = mysqli_query($dbconnection,"SELECT * FROM clevel1db ORDER BY Score DESC LIMIT 10"); 
 ...
 echo "<TD><a href=\"cdelete1.php?id=" . $row['ID'] ."\"><img src='trash.png' id='trash' width='25' height='30'/></TD>";

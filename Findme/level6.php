...
<div id="styleform1">
<form action="level6db.php" id="form11" method="POST">
...
<div id="styleform2">	
<form action="update6.php" id="form2" method="POST" name="form2">
...
<div id="movepictures">
 <img src="highscore.png" width="20px" height="30px" id="pic1"> 
	...
	<audio hidden style="position:absolute" id="myVid" autoplay="autoplay" controls="controls" loop="loop" src="8000_2s.mp3"></audio>
...
function doStuff() {
   ...
   if (event.clientX < posX + 100
		...
		backgroundAudio.volume=0.5; // or do other stuff here
		...
		backgroundAudio.volume=0.05; // or do other stuff here
		...
		backgroundAudio.volume=0.03; // or do other stuff here
		backgroundAudio.playbackRate = 2;

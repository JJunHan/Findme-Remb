...
<div id="styleform1">
<form action="level1db.php" id="form11" method="POST">
...
<div id="styleform2">	
<form action="update1.php" id="form2" method="POST" name="form2">
...
<input type="submit" value="Save Highscore!" />
 ...
 <img src="highscore.png" width="20px" height="30px" id="pic1"> 
	...
	<audio hidden style="position:absolute" id="myVid" autoplay="autoplay" controls="controls" loop="loop" src="250_2s.mp3"></audio>
...
function doStuff() {
   ...
   if (event.clientX < posX + 100
		...
		backgroundAudio.volume=0.39; // or do other stuff here
		...
		backgroundAudio.volume=0.1; // or do other stuff here
		...
		backgroundAudio.volume=0.088; // or do other stuff here
		backgroundAudio.playbackRate = 2;
		...
		backgroundAudio.volume=0.066 // or do other stuff here
		backgroundAudio.playbackRate = 2;
		...
		backgroundAudio.volume=0.045; // or do other stuff here
		backgroundAudio.playbackRate = 2;
		...
		backgroundAudio.volume=0.013; // or do other stuff here
		backgroundAudio.playbackRate = 2;

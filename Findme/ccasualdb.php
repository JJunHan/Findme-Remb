...
<body bgcolor="#e6e6fa">
<div id="move7">
	<a href="ccasual.php"><img src="compete.png" width="158px" height="68px" id="casual"></a>
	</div>
...
<form action="cdelete.php" method="POST">
            ...
            $result = @mysqli_query($dbconnection,'SELECT ID FROM ccasualdb');
            if (!$result)
            {
            ...
            $x="<SCRIPT type =text/javascript> document.write(a)</SCRIPT> ";
              ...
              $result = mysqli_query($dbconnection,"SELECT * FROM ccasualdb ORDER BY Score DESC LIMIT 10"); 
 ...
 echo "<TD><a href=\"delete.php?id=" . $row['ID'] ."\"><img src='trash.png' id='trash' width='25' height='30'/></TD>";

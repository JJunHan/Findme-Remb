...
<form action="delete1.php" method="POST">
            ...
            $result = @mysqli_query($dbconnection,'SELECT ID FROM level1db');
            if (!$result)
            {
            ...
            $x="<SCRIPT type =text/javascript> document.write(a)</SCRIPT> ";
              ...
              $result = mysqli_query($dbconnection,"SELECT * FROM level1db ORDER BY Score DESC LIMIT 10"); 
 ...
 echo "<TD><a href=\"delete1.php?id=" . $row['ID'] ."\"><img src='trash.png' id='trash' width='25' height='30'/></TD>";

...
<div id="styleform1">
<form action="level5db.php" id="form11" method="POST">
...
<div id="styleform2">	
<form action="update5.php" id="form2" method="POST" name="form2">
...
<div id="movepictures">
 <img src="highscore.png" width="20px" height="30px" id="pic1"> 
	...
	<audio hidden style="position:absolute" id="myVid" autoplay="autoplay" controls="controls" loop="loop" src="4000hz.mp3"></audio>

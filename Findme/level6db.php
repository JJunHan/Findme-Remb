...
<a href="vol_level.php"><img src="back.png" id="back1"></a>
<div id="movedatabase">
<form action="delete6.php" method="POST">
            ...
            $result = @mysqli_query($dbconnection,'SELECT ID FROM level6db');
            if (!$result)
            {
            ...
            $x="<SCRIPT type =text/javascript> document.write(a)</SCRIPT> ";
              ...
              $result = mysqli_query($dbconnection,"SELECT * FROM level6db ORDER BY Score DESC LIMIT 10"); 
  ...
  echo "<TD><a href=\"delete6.php?id=" . $row['ID'] ."\"><img src='trash.png' id='trash' width='25' height='30'/></TD>";

...
<body bgcolor="#e6e6fa">
	<div id="move5">
	<a href="clevel5.php"><img src="level5.png" width="158px" height="68px" id="image5"></a>
	</div>
<a href="freq_level.php"><img src="back.png" id="back1"></a>
<div id="movedatabase">
<form action="cdelete5.php" method="POST">
            <?PHP
            ...
            $result = @mysqli_query($dbconnection,'SELECT ID FROM clevel5db');
            if (!$result)
            {
            ...
            $x="<SCRIPT type =text/javascript> document.write(a)</SCRIPT> ";
              ...
              $result = mysqli_query($dbconnection,"SELECT * FROM clevel5db ORDER BY Score DESC LIMIT 10"); 
  ...
  echo "<TD><a href=\"cdelete5.php?id=" . $row['ID'] ."\"><img src='trash.png' id='trash' width='25' height='30'/></TD>";
